...
If you are looking to run a local system for development of integrations with a Network Gateway, you can see the [documentation on running a toy local environment](https://github.com/radixdlt/babylon-gateway/tree/v1.0.0/deployment) which runs the full stack in docker compose on a single machine.
