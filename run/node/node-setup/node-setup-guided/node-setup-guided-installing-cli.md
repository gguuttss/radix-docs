...
1.  Go to [babylon-nodecli/releases/latest](https://github.com/radixdlt/babylon-nodecli/releases/latest)
...
> By using the `babylonnode` CLI you agree to the [End User License Agreement](https://uploads-ssl.webflow.com/6053f7fca5bf627283b582c2/65006e3d3a8002f9e834320c_radixdlt.com_genericEULA.pdf).
