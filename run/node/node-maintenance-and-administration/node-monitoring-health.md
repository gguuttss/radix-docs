---
title: "Monitoring node's health"
---
...
-   *BOOTING\_PRE\_GENESIS* the node is booting and not ready to accept requests
    
-   *SYNCING* the node is catching up the network
    
-   UP the node is in sync with consensus
    
-   OUT\_OF\_SYNC the node is out of sync
    

> Refer to [Health and Metrics](https://github.com/radixdlt/babylon-node/blob/main/docs/logging-and-monitoring/health-metrics.md) documentation for more details on monitoring node’s health.
