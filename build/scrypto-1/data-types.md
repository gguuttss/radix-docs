...
You can check out the `Decimal` [Scrypto Crate Rust Docs here](https://docs.rs/scrypto/1.2.0/scrypto/math/struct.Decimal.html) to see all of them in detail.

Likewise the `PreciseDecimal` [Scrypto Crate Rust Docs here](https://docs.rs/scrypto/1.2.0/scrypto/math/precise_decimal/struct.PreciseDecimal.html)
