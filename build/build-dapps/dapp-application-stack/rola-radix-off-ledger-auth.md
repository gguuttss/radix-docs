...
ROLA is somewhat similar to the [PassKeys system of FIDO authentication](https://fidoalliance.org/passkeys/), but leverages the existence of a safe decentralized network to enable cycling of public keys used for authentication, rather than relying on fixed public keys and a cloud backup of the corresponding private key.
...
Please check [ROLA examples](https://github.com/radixdlt/rola) for more documentation and an end-to-end implementation of ROLA using a express server as backend and a TypeScript dApp as client.
