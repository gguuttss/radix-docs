...
However - it's best to avoid using the Expression("ENTIRE\_WORKTOP") command if you can help it - as the transaction cannot show up as well in wallets. Please see the guide on [conforming manifests](conforming-transaction-manifest-types) for more information.
