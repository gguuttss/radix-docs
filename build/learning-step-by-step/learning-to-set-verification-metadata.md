...
To get the Gumball Machine set up with verification metadata and working in the browser for yourself go to [the official examples repo's instructions](https://github.com/radixdlt/official-examples/tree/main/step-by-step/11-gumball-machine-dapp-verification-data#setting-up-the-gumball-machine-dapp) and follow the steps.