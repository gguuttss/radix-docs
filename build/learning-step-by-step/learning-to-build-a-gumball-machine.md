...
The `#[derive(ScryptoSbor)]` attribute allows data to be encoded into and decoded from [Scrypto SBOR](sbor), the serialization data format required by the Radix Engine. This makes it required for all custom types.
