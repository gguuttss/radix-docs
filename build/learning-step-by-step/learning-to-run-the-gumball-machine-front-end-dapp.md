...
To get the Gumball Machine working in the browser for yourself go to [the official examples repo's instructions](https://github.com/radixdlt/official-examples/tree/main/step-by-step/10-gumball-machine-front-end#running-the-example) and follow the steps.