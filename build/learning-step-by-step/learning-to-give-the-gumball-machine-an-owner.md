...
You can see this applied in the [Gumball Machine with an Owner example](https://github.com/radixdlt/official-examples/tree/main/step-by-step/05-gumball-machine-with-owner) in our official examples.
...
Now, when an owner restricted method is called, the caller has to present a  
proof of the `owner_badge` or the transaction will fail.
