...
The Radix Public Network is a Layer-1 Decentralized-Finance (DeFi) platform. Radix has been designed and built from the ground up over many years to be a full-stack for the mainstream adoption of DeFi. This is most easily understood by watching our [RadFi keynote](https://www.radixdlt.com/radfi), which explains the problems we see with DeFi right now, and how the Radix platform can enable:
