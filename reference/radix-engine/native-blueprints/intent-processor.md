...
The intent process (previously known as the transaction processor) is responsible for running transactions, by interpreting an Intent [Manifest](transaction-manifest) and execution the commands it contains.
