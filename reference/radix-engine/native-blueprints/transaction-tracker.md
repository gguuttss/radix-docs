...
-   Captures (on-Ledger) important constants used by the logic:
    ...
    -   `partition_range_start_inclusive` - the Ring-buffer’s [first usable Partition number](https://github.com/radixdlt/radixdlt-scrypto/blob/ff21f24952318387803ae720105eec079afe33f3/radix-engine/src/blueprints/transaction_tracker/package.rs#L38) (currently `65`).
        
    -   `partition_range_end_inclusive` - the Ring-buffer’s [last usable Partition number](https://github.com/radixdlt/radixdlt-scrypto/blob/ff21f24952318387803ae720105eec079afe33f3/radix-engine/src/blueprints/transaction_tracker/package.rs#L39) (currently `255`).
        
    -   `epochs_per_partition` - the [number of Epochs tracked in a single Partition](https://github.com/radixdlt/radixdlt-scrypto/blob/ff21f24952318387803ae720105eec079afe33f3/radix-engine/src/blueprints/transaction_tracker/package.rs#L40) (currently `100`).
