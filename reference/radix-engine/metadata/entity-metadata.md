...
Metadata can be added against any global entity, either at creation time, or later using the metadata module’s metadata\_set role.
...
-   [Commented Examples](https://github.com/radixdlt/radixdlt-scrypto/blob/main/radix-transactions/examples/metadata/metadata.rtm)
    
-   [Comprehensive Example Manifests](https://github.com/radixdlt/radixdlt-scrypto/tree/main/radix-transaction-scenarios/generated-examples/bottlenose/metadata) relating to [Metadata configured in manifests built here](https://github.com/radixdlt/radixdlt-scrypto/blob/main/radix-transaction-scenarios/src/scenarios/metadata.rs)