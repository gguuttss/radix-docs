...
For full details, see the [transaction structure](transaction-structure) article, but to summarize, a transaction intent contains:

-   A transaction header, defining the notary and tip.
-   Its intent core, including its:
    -   An intent header, capturing when it's valid for
    -   An optional message
    -   Its [transaction manifest](transaction-manifest)
-   Zero or more [subintents](subintents)
